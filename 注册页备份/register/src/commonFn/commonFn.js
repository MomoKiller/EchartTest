...
const baseUrl = host.indexOf('localhost') > -1 ? 'http://47.101.35.248:33207/trade/' : 'http://' + host + '/trade/'
// 配置文件
const configUrl = host.indexOf('localhost') > -1 ? 'http://47.101.35.248:33207/traderClient/config/' : 'http://' + host +'/traderClient/config/'
